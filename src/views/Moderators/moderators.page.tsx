...
function ModeratorsPage(props: any) {
    const { classes } = props;
    ...
    async function elavateUserPriviledges(uid: string) {
        return await update('/users/' + uid, { isAdmin: true });
    }
                    ...
                    <div className="profile">
                        <Card profile={true}>
                            ...
                            <CardBody profile={true}>
                                ...
                                <Button color="primary" onClick={() => elavateUserPriviledges(user.id)} round={true}>
                                    Promote
                                </Button>
...
export default withStyles(styles)(ModeratorsPage);
